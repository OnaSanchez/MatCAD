...
int main(int argc, char *argv[]) {
    ...
    for( i=0; i<num_storms; i++) {
        ...
        /* 4.3. Locate the maximum value in the layer, and its position */
         /* 
         * The next for loop couldn't be parallelized such as the for loops
         * above it because the search of the maximum and the position of 
         * the maximum in the vector layer. Moreover, the clause reduction
         * of the OpenMP is not useful because we do not only want to search
         * the maximum value, so we had to use the clause ordered  
