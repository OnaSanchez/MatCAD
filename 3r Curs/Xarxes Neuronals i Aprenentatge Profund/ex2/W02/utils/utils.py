...
def backprop(optimizer:Type[torch.MobileOptimizerType], loss:int):
...
def check_isin_cuda(variable):
    if not variable.is_cuda:
        return False
    return True
...
if __name__ == '__main__':
    ...
    b = Variable(torch.tensor(4.0), requires_grad=True)
